...
>**note**
>
>This branch is based on "antlr4-master-4.8-1" to change the compiler level to java1.6 .  
>Changed File List: ATNSerializer.java CharStreams.java CodePointCharStream.java InterpreterDataReader.java ParserRuleContext.java pom.xml StandardCharsets.java TestCharStreams.java  
